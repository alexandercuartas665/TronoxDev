...
public interface IMenuConfigService
{
    ...
    /// </summary>
    Task<ResolvedMenuDto?> GetMenuForTenantUserAsync(long tenantId, long? menuViewId, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<MenuConfigResult<bool>> DeleteViewAsync(long viewId, CancellationToken cancellationToken = default);

    /// <summary>Marca una vista como IsDefault y desmarca las demas del tenant, en transaccion.</summary>
    Task<MenuConfigResult<bool>> SetDefaultViewAsync(long viewId, CancellationToken cancellationToken = default);

    /// <summary>Arbol COMPLETO de una vista (incluye invisibles) para el editor.</summary>
    Task<MenuConfigResult<MenuViewTreeDto>> GetViewTreeAsync(long viewId, CancellationToken cancellationToken = default);
    ...
    Task<MenuConfigResult<bool>> DeleteNodeAsync(long nodeId, CancellationToken cancellationToken = default);
    ...
    Task<MenuConfigResult<MenuExportDocument>> ExportViewAsync(long viewId, CancellationToken cancellationToken = default);
