...
/// (asignacion por nodo, RQ11, port de ECOREX ADR-0035). Dada la lista plana de unidades del
/// organigrama y sus miembros, expande una Dependencia o Cargo a los TenantUserIds que pueden
/// atender el paso: (a) los Funcionarios descendientes (recursivo por ParentId), (b) los
/// miembros (OrgUnitMember) de la unidad y sus descendientes, (c) el responsable de la unidad.
/// Distinct.
/// </summary>
