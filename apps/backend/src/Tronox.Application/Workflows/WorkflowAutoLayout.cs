...
/// <summary>
/// Auto-layout de respaldo para XML BPMN sin DI (RQ11): distribuye los nodos por niveles BFS
/// desde el startEvent (columnas hacia la derecha, hermanos apilados), con los tamanos por
/// defecto. Determinista: mismo grafo -> mismas coordenadas (importa para el round-trip).
/// </summary>
