...
/// en ese caso el importador aplica auto-layout.
/// </summary>
...
/// <summary>
/// Parser de XML BPMN 2.0 estandar (namespace OMG) para el WorkflowEngine (RQ11). Reconoce el
/// subconjunto que ejecuta el motor: startEvent, task, exclusiveGateway, endEvent y
/// sequenceFlow. Del DI (diagrama) solo lee las coordenadas de los BPMNShape para el canvas
/// del editor; anotaciones y asociaciones se ignoran. El XML original NUNCA se modifica al
/// importar (round-trip con bpmn.io).
/// Validaciones: exactamente 1 startEvent, al menos 1 endEvent, ids unicos y aristas que
/// apuntan a nodos existentes.
/// </summary>
