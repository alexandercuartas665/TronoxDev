...
/// <summary>
/// Resultado tipado del WorkflowEngine (RQ11): nada de excepciones crudas hacia la capa de
/// presentacion. StuckDetected es el estado heredado del motor legacy: el avance supero el
/// tope de 50 iteraciones y la instancia quedo marcada Stuck (el Value acompana al resultado
/// para diagnostico).
/// </summary>
