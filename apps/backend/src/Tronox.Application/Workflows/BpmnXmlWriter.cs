...
/// <summary>
/// Generador de XML BPMN 2.0 estandar (RQ11). El editor usa bpmn-js (produce el XML
/// directamente), pero este writer se CONSERVA para el borrador minimo Inicio->Fin de una
/// definicion nueva y para regenerar el XML de una version fuente cuando hace falta. Round-trip
/// garantizado por test: BpmnProcessParser.Parse(Write(grafo)) reproduce el mismo grafo.
/// </summary>
public static class BpmnXmlWriter
{
    ...
    /// <summary>Tamano por defecto del canvas segun tipo.</summary>
