...
public interface INotificationService
{
    ...
    Task<int> UnreadCountForPlatformUserAsync(long platformUserId, CancellationToken cancellationToken = default);
    ...
    Task<long?> ResolveTenantUserIdAsync(long platformUserId, CancellationToken cancellationToken = default);
    ...
    Task<bool> MarkReadAsync(long notificationId, CancellationToken cancellationToken = default);

    /// <summary>Marca todas las no leidas del usuario como leidas. Devuelve cuantas marco.</summary>
    Task<int> MarkAllReadForPlatformUserAsync(long platformUserId, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task CreateAsync(long recipientTenantUserId, NotificationKind kind, string title, string body,
