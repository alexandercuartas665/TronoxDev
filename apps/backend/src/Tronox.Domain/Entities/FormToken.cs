...
/// <summary>
/// Token opaco de publicacion de un formulario por URL (/f/{token}, RQ08, port ECOREX). El token en
/// claro se muestra UNA sola vez al emitirlo; aqui solo se guarda su hash SHA-256 (hex, 64). La
/// resolucion del visor anonimo busca por hash con IgnoreQueryFilters (unico punto cross-tenant
/// permitido, acotado al hash exacto) y luego fija el tenant del token como ambiente. TENANT-SCOPED.
/// </summary>
