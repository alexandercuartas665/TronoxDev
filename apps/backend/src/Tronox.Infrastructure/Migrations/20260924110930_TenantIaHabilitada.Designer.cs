...
namespace Tronox.Infrastructure.Migrations
{
    ...
    [Migration("20260924110930_TenantIaHabilitada")]
    partial class TenantIaHabilitada
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tronox.Domain.Entities.AiAgent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Tronox.Domain.Entities.AiAgentCacheField", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("AgentId")
                        .HasDatabaseName("ix_ai_agent_cache_fields_agent_id");

                    b.HasIndex("TenantId", "AgentId", "FieldKey")
                        .IsUnique()
                        .HasDatabaseName("ix_ai_agent_cache_fields_tenant_id_agent_id_field_key");

                    b.ToTable("ai_agent_cache_fields", (string)null);
                });

            modelBuilder.Entity("Tronox.Domain.Entities.AiAgentCacheValue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("AgentId")
                        .HasDatabaseName("ix_ai_agent_cache_values_agent_id");

                    b.HasIndex("TenantId", "AgentId", "SessionId", "FieldKey")
                        .IsUnique()
                        .HasDatabaseName("ix_ai_agent_cache_values_tenant_id_agent_id_session_id_field_k");

                    b.ToTable("ai_agent_cache_values", (string)null);
                });

            modelBuilder.Entity("Tronox.Domain.Entities.AiAgentPrompt", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Tronox.Domain.Entities.AiAgentResource", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Tronox.Domain.Entities.AiAgentRunLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Tronox.Domain.Entities.BuzonCorreo", b =>
                {
                    ...
                    b.Property<long?>("AgenteIaId")
                        .HasColumnType("bigint")
                        .HasColumnName("agente_ia_id");
                    ...
                    b.HasIndex("AgenteIaId")
                        .HasDatabaseName("ix_buzones_correo_agente_ia_id");
            ...
            modelBuilder.Entity("Tronox.Domain.Entities.CorreoRecibido", b =>
                {
                    ...
                    b.Property<string>("ClasificacionJson")
                        .HasColumnType("text")
                        .HasColumnName("clasificacion_json");
            ...
            modelBuilder.Entity("Tronox.Domain.Entities.Radicado", b =>
                {
                    ...
                    b.Property<string>("RemitenteMunicipio")
                        .HasColumnType("text")
                        .HasColumnName("remitente_municipio");
            ...
            modelBuilder.Entity("Tronox.Domain.Entities.Tercero", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("OrdenEntidad")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("orden_entidad");
                    ...
                    b.Property<string>("SectorAdministrativo")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("sector_administrativo");
                    ...
                    b.HasIndex("MunicipioId")
                        .HasDatabaseName("ix_terceros_municipio_id");

                    b.HasIndex("PaisId")
                        .HasDatabaseName("ix_terceros_pais_id");

                    b.HasIndex("RepresentanteLegalId")
                        .HasDatabaseName("ix_terceros_representante_legal_id");

                    b.HasIndex("TenantId", "Estado")
                        .HasDatabaseName("ix_terceros_tenant_id_estado");

                    b.HasIndex("TenantId", "TipoDocumento", "NumeroDocumento")
                        .IsUnique()
                        .HasDatabaseName("ix_terceros_tenant_id_tipo_documento_numero_documento");
            ...
            modelBuilder.Entity("Tronox.Domain.Entities.AiAgentCacheField", b =>
                {
                    b.HasOne("Tronox.Domain.Entities.AiAgent", "Agent")
                        .WithMany()
            ...
            modelBuilder.Entity("Tronox.Domain.Entities.BuzonCorreo", b =>
                {
                    b.HasOne("Tronox.Domain.Entities.AiAgent", "AgenteIa")
                        .WithMany()
                        .HasForeignKey("AgenteIaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_buzones_correo_ai_agents_agente_ia_id");
            ...
            modelBuilder.Entity("Tronox.Domain.Entities.Tercero", b =>
                {
                    b.HasOne("Tronox.Domain.Entities.Municipio", "Municipio")
                        .WithMany()
                        .HasForeignKey("MunicipioId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_terceros_municipios_municipio_id");
                    ...
                    b.HasOne("Tronox.Domain.Entities.Tercero", "RepresentanteLegal")
                        .WithMany()
                        .HasForeignKey("RepresentanteLegalId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_terceros_terceros_representante_legal_id");
