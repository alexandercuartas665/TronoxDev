...
{
    /// <summary>URL base del servidor Evolution API (p.ej. https://evo.ecorex.com.co).</summary>
    ...
    /// <summary>URL publica fija para produccion (p.ej. https://app.ecorex.com.co).</summary>
