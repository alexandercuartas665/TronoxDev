    ...
    public partial class AddMenuConfig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    menu_view_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    parent_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    kind = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    icon_key = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    legacy_code = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
